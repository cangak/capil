...
$pegawai->USER_ID = $_POST['id'];
$pegawai->NM_USER = $_POST['form']['NM_USER'];
$pegawai->JABAT_USER = $_POST['form']['NIP_USER'];
$pegawai->NIP_USER = $_POST['form']['JABAT_USER'];
$saved = $pegawai->Save();
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				echo '<meta http-equiv="refresh" content="2;URL=\'/?' . urlc('module=pegawai') . '\'" />';
			}
		}
...
$pegawai->NM_USER = $_POST['form']['NM_USER'];
$pegawai->NIP_USER = $_POST['form']['NIP_USER'];
$pegawai->JABAT_USER = $_POST['form']['JABAT_USER'];
$saved = $pegawai->Create();
