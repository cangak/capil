...
if ($session->wes_entek()) {
	...
	case "edit":
		...
		if ($error === true) {
			...
			$m_kegiatan->ID_KGIAT = $_POST['id'];
$m_kegiatan->NM_KGIAT = $_POST['form']['NM_KGIAT'];
$m_kegiatan->IS_AKTIF = $_POST['IS_AKTIF'];
$saved = $m_kegiatan->Save();
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				echo '<meta http-equiv="refresh" content="2;URL=\'/?' . urlc('module=m_kegiatan') . '\'" />';
			}
		}
