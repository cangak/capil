...
->setBold(true)
->setSize(14);
$objPHPExcel->setActiveSheetIndex(0)->getStyle("A4:H4")->getFont()->setBold(true);
$objPHPExcel->setActiveSheetIndex(0)->getStyle('A4:H4')->getFill()->getStartColor()->setRGB('CCCCCC');
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Laporan Pendaftaran');
