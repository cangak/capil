...
if ($session->wes_entek()) {
	...
	case "edit":
		...
		if ($error === true) {
			...
			$m_kegiatan_b->ID_KGIAT_B = $_POST['id'];
$m_kegiatan_b->ID_KGIAT_A = $_POST['form']['ID_KGIAT_A'];
$m_kegiatan_b->NM_KEGIAT_B = $_POST['form']['NM_KEGIAT_B'];
$m_kegiatan_b->LAMA = $_POST['form']['LAMA'];
$m_kegiatan_b->KODE_REG = $_POST['form']['KODE_REG'];
$saved = $m_kegiatan_b->Save();
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				echo '<meta http-equiv="refresh" content="2;URL=\'/?' . urlc('module=m_kegiatan_b') . '\'" />';
			}
		}
	...
	case "tambah":
		...
		if ($error === true) {
			...
			$m_kegiatan_b->ID_KGIAT_B = "";
$m_kegiatan_b->ID_KGIAT_A = $_POST['form']['ID_KGIAT_A'];
$m_kegiatan_b->NM_KEGIAT_B = $_POST['form']['NM_KEGIAT_B'];
$m_kegiatan_b->LAMA = $_POST['form']['LAMA'];
$m_kegiatan_b->KODE_REG = $_POST['form']['KODE_REG'];
$saved = $m_kegiatan_b->Create();
