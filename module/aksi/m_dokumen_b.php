...
if ($session->wes_entek()) {
	...
	case "edit":
		...
		if ($error === true) {
			...
			$m_dokumen_b->ID_DOKU_B = $_POST['id'];
$m_dokumen_b->ID_KGIAT_B = $_POST['form']['ID_KGIAT_B'];
$m_dokumen_b->NM_DOKU_B = $_POST['form']['NM_DOKU_B'];
$saved = $m_dokumen_b->Save();
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				echo '<meta http-equiv="refresh" content="2;URL=\'/?' . urlc('module=m_dokumen_b') . '\'" />';
			}
		}
	...
	case "tambah":
		...
		if ($error === true) {
			...
			$m_dokumen_b->ID_DOKU_B = "";
$m_dokumen_b->ID_KGIAT_B = $_POST['form']['ID_KGIAT_B'];
$m_dokumen_b->NM_DOKU_B = $_POST['form']['NM_DOKU_B'];
$saved = $m_dokumen_b->Create();
